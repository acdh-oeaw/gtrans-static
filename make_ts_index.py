...
try:
    client.collections["gtrans"].delete()
...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        cfts_record["resolver"] = f"https://github.com/acdh-oeaw/gtrans-static/{record['id']}"
...
print(make_index)
print("done with indexing gtrans")

make_index = CFTS_COLLECTION.documents.import_(cfts_records, {"action": "upsert"})
print(make_index)
print("done with cfts-index gtrans")
